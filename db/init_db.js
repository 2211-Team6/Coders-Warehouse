...
async function populateInitialData() {
  try {
    ...
    const productsToCreate = [
      ...
      { title: "COLOMBIAN BLEND COFFEE", description: "Reach peak performance with our kicked-up Colombian blend, made with smooth arabica beans from the Sierra Nevada de Santa Marta Mountains of Colombia and naturally high-caffeine Indian robusta beans. From morning routines to afternoon pick-me-ups, this bold brew always has your back, with notes of toasted almonds and ripe plums", price: 1999, quantity: 32, url: "https://cdn.shopify.com/s/files/1/0271/7209/products/Death_Wish_Coffee_DarkRoast_1LB_Ground_Front.jpg?v=1630186442" },
      { title: "Ground Hair Bender", description: "Headed on the road and not sure if you will have access to a coffee grinder? This 12oz bag of coffee is pre-ground at our roastery on a setting the works for just about any drip brewer.", price: 1600, quantity: 5, url: "https://stumptown-shop.imgix.net/products/Hair_Bender_Ground_2.png?v=1644615747&auto=format,compress&w=375" },
      ...
      { title: "Sinatra Select", description: "Sinatra Select pays tribute to Jack’s biggest fan: Frank Sinatra. Made with our unique “Sinatra Barrels” that have deep grooves specially carved into their staves to expose the whiskey to extra layers of toasted oak. This added exposure imparts a rich amber color, bold character, and pleasant smokiness, punctuated by an incredibly smooth vanilla finish. Much like Frank, this Tennessee Whiskey is one of a kind.", price: 29999, quantity: 6, url: "https://prnewswire2-a.akamaihd.net/p/1893751/sp/189375100/thumbnail/entry_id/0_s9i6fwmx/def_height/2700/def_width/2700/version/100012/type/1"},
      { title: "Jordan 6 Retro Black Infrared", description: "The Air Jordan 6 Retro 'Infrared' 2019 is a 2019 re-release of the OG colorway. The shoe's black nubuck upper includes a reflective 3M layer, with perforations throughout for breathability. The heel, tongue and lace lock sport Infrared accents, with the color also featured on the signature midsole detailing. Visible Air in the heel provides cushioning, while the tranlucent sections continue down onto the outsole for traction.", price: 23400, quantity: 9, url: "https://images.stockx.com/images/Air-Jordan-6-Retro-Black-Infrared-2019-Product.jpg?fit=fill&bg=FFFFFF&w=1200&h=857&fm=webp&auto=compress&dpr=2&trim=color&updated_at=1606315701&q=75" }
